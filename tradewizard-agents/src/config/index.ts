...
const EngineConfigSchema = z
  .object({
    polymarket: z.object({
      ...
      defaultSortBy: z.enum(['volume24hr', 'liquidity', 'competitive', 'marketCount', 'id']).default('volume24hr'),
...
export function loadConfig(): EngineConfig {
  const config: EngineConfig = {
    polymarket: {
      ...
      defaultSortBy: (process.env.POLYMARKET_DEFAULT_SORT_BY as 'volume24hr' | 'liquidity' | 'competitive' | 'marketCount' | 'id') || 'volume24hr',
